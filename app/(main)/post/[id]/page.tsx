            ...
            <div className="flex-1 min-w-0 flex flex-col gap-5">
              ...
              <div className="flex justify-between items-center flex-wrap gap-2.5">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-bg-surface">
                  <StarIcon size={16} /><span className="text-sm font-semibold text-amber-500">{(post.rating || 0).toFixed(1)}</span>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-3 px-4">
            ...
            <div className="flex justify-between items-center flex-wrap gap-2">
              ...
              <div className="flex items-center gap-1 px-2 py-1 rounded-2xl bg-bg-surface">
                <StarIcon size={14} /><span className="text-xs font-semibold text-amber-500">{(post.rating || 0).toFixed(1)}</span>
              </div>
            </div>
